#modulo que configura el agente que se mueve en el laberinto, que va a ser resuelto por A*
...
class Agent: #clase agente que va a ser quien resuelva el laberinto
    ...
    def solve_by_aStar(self, env): #resuelve el problema del laberinto a travez del algoritmo A*
        ...
        frontier = LinkedList() #cola de prioridad que nos sirve en A*
        solution = aStar(grafo, p_final_codificado, p_inicial_codificado, frontier, filas_grilla) #A* nos va a dar las acciones a realizar
